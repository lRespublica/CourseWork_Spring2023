...
\small{
\begin{bmatrix} 
u = \frac{r}{r^2-1}; & du = \frac{(r^2-1)^2 - 4r^2(r^2-1)}{(r^2-1)^4}dr\\
dv = sin\:r\ dr & v = -cos\:r
\end{bmatrix}} 
= \left. \frac{-2\ cos\:r\ }{(r^2-1)^2} \right|_{\sqrt{x+1}}^{+\infty} + o(\int_{_{\sqrt{x+1}}}^{_{+\infty}} \frac{cos\;r}{(r^2-1)^2}dr) = \frac{2cos\sqrt{x+1}}{x^2} + o(\int_x^{+\infty} \frac{cos\sqrt{t+1}}{t^2}dt)\) 

\hspace{1cm}

\(F(x) = -\frac{2sin\sqrt{x+1}}{x} + \frac{4cos\sqrt{x+1}}{x^2} + o(-\frac{2sin\sqrt{x+1}}{x} + \frac{4cos\sqrt{x+1}}{x^2}),\quad x \to +\infty\)
}
