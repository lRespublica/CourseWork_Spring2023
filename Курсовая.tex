...
\[f(x) = \frac{1}{\sqrt{e}}(1-\frac{5x^2}{24}+O(x^4)),\quad x \to 0\]
}
...
\(f(x) = x(-\frac{1}{3x} + \frac{5}{18x^2} + O(\frac{1}{x^3})) = -\frac{1}{3} + \frac{5}{18x} + O(\frac{1}{x^2}),\quad x \to +\infty\)
}
...
Следовательно, \[x_n = \pi n + (-1)^n \frac{1}{\pi^2 n^2} + o(\frac{1}{n^2}),\quad n \to +\infty\]
}
...
Так как в последнем выражении подынтегральная функция имеет асимптотику \(O(\frac{1}{t^2}),\  t \to + \infty\), то несобственный интеграл \(\int_1^{+\infty} (\sqrt{t^2+1}e^{1/t} - t - 1 - \frac{1}{t})dt\) сходится. Обозначим его значение за A. Тогда
